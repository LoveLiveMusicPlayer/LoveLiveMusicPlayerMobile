      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              showGroupButton("assets/drawer/logo_lovelive.png",
                  innerWidth: 107, innerHeight: 27),
              showGroupButton("assets/drawer/logo_us.png",
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              showGroupButton("assets/drawer/logo_aqours.png", onTap: () async {
              ...
              showGroupButton("assets/drawer/logo_nijigasaki.png",
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              showGroupButton("assets/drawer/logo_liella.png",
                  innerWidth: 100, innerHeight: 35),
              showGroupButton("assets/drawer/logo_allstars.png",
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          SvgPicture.asset("assets/drawer/drawer_data_sync.svg",
                      ...
                      Row(
                        children: [
                          SvgPicture.asset("assets/drawer/drawer_secret.svg",
                              height: 20.h, width: 20.h),
                          SizedBox(width: 8.w),
                          Text("关于和隐私",
                              style: TextStyle(
