const Map<String, String> zhCN = {
  ...
  'colorful_mode': '炫彩模式',
  'splash_photo': '开屏图片',
  'enable_background_photo': '启用背景图片',
  'choose_background_photo': '选择背景图片',
  'fetch_songs': '数据更新',
  'clear_database': '清理数据',
  ...
  'share_menu': '分享歌单',
  'no_qq': 'TIM/QQ未安装',
  'version_incompatible': 'APP与PC版本不匹配，请前往博客更新',
  'no_found_music1': '未找到此歌曲',
  ...
  'net_error': '网络错误',
  'hint': '提示',
  'use_http_music': '使用HTTP曲库',
  'input_http_url': '输入HTTP地址',
  'support_http_characters': '支持字符: a-z A-Z 0-9 .:/_-',
