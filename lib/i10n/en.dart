const Map<String, String> enUS = {
  ...
  'search_lyric': 'Search lyric again',
  'search_lyric_success': 'search lyric success',
  'search_lyric_failed': 'search lyric failed',
  ...
  'hint': 'Hint',
  'use_http_music': 'Play music by Http',
  'input_http_url': 'Enter Http address',
  ...
  'select_time': 'Please select time（unit：minutes）',
  'upgrading': 'Upgrading...',
  'upgrade_on_next_time': 'The update will take effect on the next startup',
  'end_time': 'End time: ',
  'timed_to_stop': 'Timed off',
  'timed_to_stop_remain': 'Timed off, remaining',
  'minutes': 'minute(s)',
...
Ⅴ. Deleting, modifying or adding functions of computer information networks without permission.
  ...
  'share_error': 'Share failed, error code: ',
  'share_success': 'Share success',
  'share_cancel': 'Cancel share',
